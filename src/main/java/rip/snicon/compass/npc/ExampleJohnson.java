...
import nub.wi1helm.template.npc.TemplatePlayerNPC;
import nub.wi1helm.template.npc.goals.LookAtPlayerGoal;
import rip.snicon.compass.instances.MysteryInstanceType;
import rip.snicon.compass.utils.TextUtils;

public class ExampleJohnson extends TemplatePlayerNPC {

    public ExampleJohnson() {

        // Set Spawn Position
        setPosition(new Pos(44.0, 9.5, 26.8, 0.0f, 0.0f));
        // Set Skin Layers
...
/*
        setName(new TemplateText(
                ...
                TextUtils.convertStringToComponent("<yellow>Hi " + player.getUsername() + "</yellow>")
        ));
