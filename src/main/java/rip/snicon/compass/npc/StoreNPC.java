...
public class StoreNPC extends TemplatePlayerNPC {
    public StoreNPC() {
        setPosition(new Pos(17.5,9,25.5, -90, 0));
        ...
        */
/*
        setName(new TemplateText(TextUtils.convertStringToComponent("<yellow>Right Click</yellow>"),
                                 TextUtils.convertStringToComponent("<light_purple>Store E'verse</light_purple>")
        ));
        ...
        setGoal(new LookAtPlayerGoal(this,13, getSpawnPosition()));
