...
public class MOTD {
    ...
    public static Component createMOTD() {
        ...
        for (Map.Entry<String, String> entry : motdConfig.entrySet()) {
            ...
            motd = motd.append(TextUtils.convertStringListToComponent(row1)); // Pass row1 directly to getComponent
            ...
            if (row2Options != null && !row2Options.isEmpty()) {
                ...
                motd = motd.append(TextUtils.convertStringListToComponent(selectedRow2)); // Pass selectedRow2 directly to getComponent
            }
